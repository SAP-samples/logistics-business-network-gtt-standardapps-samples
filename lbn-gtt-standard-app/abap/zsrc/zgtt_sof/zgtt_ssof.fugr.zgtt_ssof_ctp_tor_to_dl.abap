...
*"--------------------------------------------------------------------
  ...
  TRY.
      ...
      " *** collect F.O./F.U. changes that affects outbound deliveries ***
      DATA(lo_tor_changes)  = NEW zcl_gtt_sof_ctp_tor_changes(
      ...
      IF <lt_delivery_chng> IS ASSIGNED AND <lt_delivery_chng> IS NOT INITIAL.
        ...
        DATA(lo_dl_head_data) = NEW zcl_gtt_sof_ctp_dat_tor_to_dlh(
                                  it_delivery_chng = <lt_delivery_chng>
                                  it_tor_root      = it_tor_root_sstring
                                  it_tor_item      = it_tor_item_sstring ).

        DATA(lo_dl_head_sender) = zcl_gtt_sof_ctp_snd_tor_to_dlh=>get_instance( ).
        ...
        DATA(lo_dlv_item_data) = NEW zcl_gtt_sof_ctp_dat_tor_to_dli(
                                   it_delivery_chng = <lt_delivery_chng> ).

        DATA(lo_dlv_item_sender) = zcl_gtt_sof_ctp_snd_tor_to_dli=>get_instance( ).
