INTERFACE zif_gtt_mia_factory
  ...
  METHODS get_bo_reader
    ...
    RETURNING
      VALUE(ro_bo_reader) TYPE REF TO zif_gtt_mia_tp_reader .
  METHODS get_ef_parameters
    ...
    RETURNING
      VALUE(ro_ef_parameters) TYPE REF TO zif_gtt_mia_ef_parameters .
  METHODS get_ef_processor
    IMPORTING
      !is_definition         TYPE zif_gtt_mia_ef_types=>ts_definition
      !io_bo_factory         TYPE REF TO zif_gtt_mia_factory
      !iv_appsys             TYPE /saptrx/applsystem
      !is_app_obj_types      TYPE /saptrx/aotypes
      !it_all_appl_tables    TYPE trxas_tabcontainer
      ...
      !it_app_objects        TYPE trxas_appobj_ctabs
    RETURNING
      VALUE(ro_ef_processor) TYPE REF TO zif_gtt_mia_ef_processor
    RAISING
      cx_udm_message .
  METHODS get_pe_filler
    ...
    RETURNING
      VALUE(ro_pe_filler) TYPE REF TO zif_gtt_mia_pe_filler
    RAISING
      cx_udm_message .
ENDINTERFACE.
