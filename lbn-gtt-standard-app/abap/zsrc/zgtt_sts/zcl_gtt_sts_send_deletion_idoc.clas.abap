class ZCL_GTT_STS_SEND_DELETION_IDOC definition
  public
  final
  create private .
...
public section.
  ...
  class-methods GET_INSTANCE
    ...
    returning
      value(RO_UPDATER) type ref to ZCL_GTT_STS_SEND_DELETION_IDOC
    raising
      CX_UDM_MESSAGE .
...
private section.
  ...
  types:
    ...
    END OF ts_idoc_data .
  types:
    tt_idoc_data TYPE STANDARD TABLE OF ts_idoc_data  WITH EMPTY KEY .
...
CLASS ZCL_GTT_STS_SEND_DELETION_IDOC IMPLEMENTATION.
  ...
  METHOD is_extractor_exist.
    ...
    SELECT COUNT(*)
      ...
      WHERE trk_obj_type = iv_trk_obj_type
        AND torelevant   = abap_true. "#EC CI_BYPASS
