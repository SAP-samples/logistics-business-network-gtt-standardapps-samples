class ZCL_GTT_STS_PE_TRK_ONCU_FO_FIL definition
  public
...
CLASS ZCL_GTT_STS_PE_TRK_ONCU_FO_FIL IMPLEMENTATION.
  ...
  METHOD zif_gtt_sts_pe_filler~get_planned_events.
    ...
    DATA:
      ...
      lo_cu_filler        TYPE REF TO zcl_gtt_sts_pe_trk_oncu_plncuf,
    ...
    lo_cu_filler = NEW zcl_gtt_sts_pe_trk_oncu_plncuf( ).
    lo_cu_filler->get_planned_events(
      EXPORTING
