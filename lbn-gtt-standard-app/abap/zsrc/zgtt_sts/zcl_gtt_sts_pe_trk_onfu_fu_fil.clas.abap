class ZCL_GTT_STS_PE_TRK_ONFU_FU_FIL definition
  public
...
CLASS ZCL_GTT_STS_PE_TRK_ONFU_FU_FIL IMPLEMENTATION.
  ...
  METHOD shp_arrival.
    ...
    LOOP AT it_stop ASSIGNING FIELD-SYMBOL(<ls_stop>) USING KEY parent_seqnum WHERE parent_node_id = <ls_root>-node_id.
      ...
      CHECK <ls_stop>-stop_cat = /scmtms/if_common_c=>c_stop_category-inbound.
      ...
      IF <ls_root>-trmodcod = zif_gtt_sts_constants=>cs_trmodcod-postal_service."Postal Service
      ...
      ELSE.
        ...
        lv_exp_datetime = <ls_capa_stop>-plan_trans_time.
      ENDIF.
  ...
  METHOD shp_departure.
    ...
    LOOP AT it_stop ASSIGNING FIELD-SYMBOL(<ls_stop>) USING KEY parent_seqnum WHERE parent_node_id = <ls_root>-node_id.
      ...
      CHECK <ls_stop>-stop_cat = /scmtms/if_common_c=>c_stop_category-outbound.
