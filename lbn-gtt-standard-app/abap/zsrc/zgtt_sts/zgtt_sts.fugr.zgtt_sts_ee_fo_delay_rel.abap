FUNCTION zgtt_sts_ee_fo_delay_rel.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  ...
  e_result = zif_gtt_sts_ef_constants=>cs_condition-false.
  ...
  DATA(lv_is_correct_tor_cat) = xsdbool( <ls_tor_root>-tor_cat = /scmtms/if_tor_const=>sc_tor_category-active  OR
                                         <ls_tor_root>-tor_cat = /scmtms/if_tor_const=>sc_tor_category-booking OR
