class ZCL_GTT_STS_PE_TRK_ONCU_FU_FIL definition
  public
...
CLASS ZCL_GTT_STS_PE_TRK_ONCU_FU_FIL IMPLEMENTATION.
  ...
  METHOD zif_gtt_sts_pe_filler~get_planned_events.
    ...
    DATA:
      ...
      lo_trk_oncu_plncu   TYPE REF TO zcl_gtt_sts_pe_trk_oncu_plncu.
    ...
    lo_trk_oncu_plncu = NEW zcl_gtt_sts_pe_trk_oncu_plncu( ).
    lo_trk_oncu_plncu->get_planned_events(
      EXPORTING
